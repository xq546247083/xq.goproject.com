...
func GetNowStr() string {
	return ToTimeString(time.Now())
}

//Format format time like java, such as: yyyy-MM-dd HH:mm:ss
// t：时间
// format：格式化字符串
// 返回值：
// 格式化后的字符串
...
//ToInt64 转换成yyyyMMddHHmmssms的格式
